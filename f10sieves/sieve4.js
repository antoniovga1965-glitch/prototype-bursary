...
const documentratio = {
    sec_birthcertfile: { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'Birth Certificate' },
    sec_admission:     { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'Admission Letter' },
    sec_fee:           { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'Fee Statement' },
    sec_death:         { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'Death Certificate' },
    sec_kcse:          { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'KCPE Certificate' },
    sec_results:       { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'Result Slip' },
    sec_income_proof:  { ratio: 1.414, tolerance: 2.0, minSize: 1, name: 'Income Proof' },
}
